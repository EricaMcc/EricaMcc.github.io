...
Operators perform some action on one or more operands
...
3. The ternary operator requires three operands
...
if (3 > 2 && 4 > 2) {
    return true;
} else {return false;} // returns true
...
// In addition to ++ and --, typeof is also a unary operator
// typeof operators returns the datatype of the operand
